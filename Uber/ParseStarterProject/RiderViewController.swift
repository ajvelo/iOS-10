...
//
//  Created by ANDREAS VELOUNIAS on 11/08/2017.
   ...
   override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
    ...
    override func viewDidLoad() {
        ...
        query.findObjectsInBackground(block: { (objects, error) in
            ...
            self.callAnUberButton.setTitleColor(UIColor.blue, for: .normal)
                                ...
                                if let driverLocations = objects {
                                    ...
                                    for driverLocationObject in driverLocations {
                                        ...
                                        if let driverLocation = driverLocationObject["location"] as? PFGeoPoint {
                                            ...
                                            self.callAnUberButton.setTitleColor(UIColor.red, for: .normal)
                                            
                                            self.callAnUberButton.setTitle("Your driver is" + String(format: "%.1f", (distance * 100) / 100) + " km away!", for: [])
